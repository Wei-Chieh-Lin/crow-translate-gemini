...
public:
     ...
     *
     * Affects LibreTranslate and Gemini.
     *
     * @param engine engine
    ...
    /**
     * @brief Set Gemini model name
     *
     * The model name (e.g. "gemini-2.0-flash") is used for the Gemini API endpoint.
     *
...
private:
    ...
    void buildGeminiDetectStateMachine();
    ...
    static constexpr int s_geminiTranslateLimit = 30000;
